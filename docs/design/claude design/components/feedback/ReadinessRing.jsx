 ...
 */
export function ReadinessRing({ value = 0, size = 130, stroke = 9, label = "Readiness", caption = null, style = {} }) {
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px", ...style }}>
      <div style={{ position: "relative", width: size, height: size }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
          <b style={{ fontFamily: "var(--font-serif)", fontSize: size * 0.23, fontWeight: 500, letterSpacing: "-0.02em", color: "var(--text)" }}>{value}%</b>
          <span style={{ fontSize: "10.5px", color: "var(--text-3)", letterSpacing: "0.07em", textTransform: "uppercase", marginTop: "1px" }}>{label}</span>
        </div>
      </div>
